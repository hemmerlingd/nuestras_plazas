<?
	function existe($lista_fechas,$dia,$mes)
	{
	...
	function draw_calendar($month,$year,$fechas){
...
echo json_encode(array( 'html' => draw_calendar($_REQUEST['mes'],$_REQUEST['anio'],explode($_REQUEST['fechas'],",")) ));
?>